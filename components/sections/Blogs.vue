<template>
    <div class="relative">
        ...
        <div class="container mx-auto py-[30px] lg:py-[60px] ">
            ...
            <div v-if="blogs && blogs.length" class="container px-[16px] mx-auto mt-32">
                <div class="grid grid-cols-12 gap-[20px]">
                    <div class="col-span-12 md:col-span-7" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <img class="absolute w-full h-full top-0 left-0 object-cover" :src="blogs[0]?.image_url" :alt="blogs[0]?.title">
                            ...
                            <nuxt-link :to="`/blogs/${item.slug}`" data-aos="fade-up" :data-aos-delay="index + 1 +'00'" v-for="(item,index) in blogs.slice(1,4)" :key="index" class="flex justify-center align-items-center gap-4 group border-b border-solid border-[#E6ECF0] last:border-b-0 py-[20px]">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="flex items-center mt-[8px] gap-[6px]">
                                        ...
                                        <h6 class="text-[#74787D] font-normal text-[14px] leading-130"   >{{item.full_name}}</h6>
                                    </div>
                                </div>
                            </nuxt-link>
                            </div>
