<template>
    <div class="main-form  sm:px-[20px] lg:px-0 py-[60px] relative">
        ...
        <img src="@/static/img/bg-form-pattern.svg" class="absolute bottom-0 w-full z-[0] h-[80%]" data-aos="fade-up"
            alt="">
                    ...
                    <div class="flex flex-col relative" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <el-select v-model="form.type" placeholder="Select" style="width: 100%">
                            <el-option class="size-of-car-select" label="Small Car" value="Small Car">
                                <svg xmlns="http://www.w3.org/2000/svg" width="576" height="228" viewBox="0 0 576 228"
                            ...
                            <el-option class="size-of-car-select" label="Mid Size Car" value="Mid Size Car">
                                <svg xmlns="http://www.w3.org/2000/svg" width="924" height="284" viewBox="0 0 924 284"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Large Car" value="Large Car"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1036" height="300" viewBox="0 0 1036 300"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Sports Car" value="Sports Car"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="968" height="294" viewBox="0 0 968 294"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Small SUV" value="Small SUV"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="794" height="317" viewBox="0 0 794 317"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Mid Size SUV" value="Mid Size SUV"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="875" height="334" viewBox="0 0 875 334"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Large SUV" value="Large SUV"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1036" height="396" viewBox="0 0 1036 396"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Hypercar" value="Hypercar"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="340" height="98" viewBox="0 0 340 98"
                                    fill="none" class="svg replaced-svg">
                                    ...
                                    <defs>
                                        <clipPath id="a">
                                            <path fill="#fff" transform="translate(.7 .7)" d="M0 0h339.3v97.1H0z">
                                            </path>
                                        </clipPath>
                                    </defs>
                                </svg>
                            ...
                            <el-option class="size-of-car-select" label="Mini Van" value="Mini Van"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1004" height="352" viewBox="0 0 1004 352"
                                    fill="none" class="svg replaced-svg">
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#09265E"></path>
                                    <path d="M737.4 109.3h-2.8.3-.8v-.2a1.6 1.6 0 0 1 1.2-1.3h.7a1.7 1.7 0 0 1 1.5 1.5z"
                                        fill="#09265E"></path>
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Medium Pickup" value="Medium Pickup"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="900" height="314" viewBox="0 0 900 314"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Large Pickup" value="Large Pickup"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="992" height="332" viewBox="0 0 992 332"
                                    fill="none" class="svg replaced-svg">
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Fullsize Van" value="Fullsize Van"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1170" height="494" viewBox="0 0 1170 494"
                                    fill="none" class="svg replaced-svg">
                                    <path
                                        ...
                                        fill="#09265E"></path>
                                    <path d="m1139.8 291.1 16 9-1.9-45.4-17.7-8 3.5 44.4z" fill="#09265E"></path>
                                    <path
                            ...
                            <el-option class="size-of-car-select" label="Travel Trailer" value="Travel Trailer"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="720" height="408" viewBox="0 0 720 408"
                                    fill="none" class="svg replaced-svg">
                            ...
                            <el-option class="size-of-car-select" label="Boat Trailer" value="Boat Trailer"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="800" height="347" viewBox="0 0 800 347"
                                    fill="none" class="svg replaced-svg">
                                    ...
                                    <path d="M147.4 312.2a8.9 8.9 0 1 1 0-17.7 8.9 8.9 0 0 1 0 17.7z" fill="#09265E">
                                    </path>
                                    ...
                                    <path d="M596.4 340.8a37.4 37.4 0 1 1 0-74.8 37.4 37.4 0 0 1 0 74.8z"
                                        stroke="#09265E" stroke-width="11" stroke-miterlimit="10"></path>
                                    <path d="M596.4 312.2a8.9 8.9 0 1 1 0-17.7 8.9 8.9 0 0 1 0 17.7z" fill="#09265E">
                                    </path>
                                    ...
                                    <path d="M693.4 340.8a37.4 37.4 0 1 1 0-74.8 37.4 37.4 0 0 1 0 74.8z"
                                        stroke="#09265E" stroke-width="11" stroke-miterlimit="10"></path>
                                    <path d="M693.4 312.2a8.9 8.9 0 1 1 0-17.7 8.9 8.9 0 0 1 0 17.7z" fill="#09265E">
                                    </path>
                            ...
                            <el-option class="size-of-car-select" label="Golf Cart" value="Golf Cart"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="417" height="313" viewBox="0 0 417 313"
                                    fill="none" class="svg replaced-svg">
                                    ...
                                    <path d="M356.6 278.4a8.8 8.8 0 1 1 0-17.6 8.8 8.8 0 0 1 0 17.6z" fill="#09265E">
                                    </path>
                                    ...
                                    <path d="m322.3 283.9 34.3-14.3L371 304" stroke="#09265E" stroke-width="3.7"
                                        stroke-miterlimit="10"></path>
                                    <path d="M42 306.8a37.2 37.2 0 1 1 0-74.4 37.2 37.2 0 0 1 0 74.4z" stroke="#09265E"
                                        stroke-width="9.2" stroke-miterlimit="10"></path>
                                    <path d="M42 278.4a8.8 8.8 0 1 1 0-17.6 8.8 8.8 0 0 1 0 17.6z" fill="#09265E">
                                    </path>
                            ...
                            <el-option class="size-of-car-select" label="Dually Pickup" value="Dually Pickup"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="1200" height="400" viewBox="0 0 1200 400"
                                    fill="none" class="svg replaced-svg">
                                    <path
                                        ...
                                        fill="#09265E"></path>
                                    <path d="M149.3 337.8a25 25 0 1 0 0-50.2 25 25 0 0 0 0 50.2z" fill="#09265E"></path>
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#09265E"></path>
                                    <path d="M962.7 337.8a25 25 0 1 0 0-50.2 25 25 0 0 0 0 50.2z" fill="#09265E"></path>
                                    <path
