<template>
    <div class="main-form  sm:px-[20px] lg:px-0 py-[60px] relative">
        <img src="@/static/img/form-top.png" class="absolute top-0 right-0" data-aos="fade-rigt" alt="">
        <img src="@/static/img/form-top.png" class="absolute bottom-0 left-0 rotate-180" alt="">
        <img src="@/static/img/bg-form-pattern.svg" class="absolute bottom-0 w-full z-[0] h-[80%]" alt="">

        <div class="container px-[16px] mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-[16px]">
                <div class="flex flex-col justify-between items-start">
                    <div class="flex flex-col justify-start items-start">
                        <SectionTitle title="Start your vehicle shipment with Albatross Auto Shipping now."
                            :center="false" isWhite='true' />
                        <h4 class="text-lightGray text-[26px] leading-130 font-normal mt-[8px]">Fill out the form.</h4>
                    </div>
                    <div class="flex items-center gap-[16px] mt-[16px] lg:mt-0">
                        <img src="@/static/icons/headset.svg" alt="head">
                        <div class="flex flex-col">
                            <a href="tel: +18653818015"
                                class="text-white leading-130 font-medium text-[22px] lg:text-[28px] duration-300 hover:text-dBlue">(865)
                                381-8015</a>
                            <h4 class="text-[#ffffff] text-[16px] leading-[19px] font-normal">Phone number in case of
                                anything</h4>
                        </div>
                    </div>
                </div>
                <div class="min-h-[420px]">
                    <div class="mb-[20px]" v-if="!isSent">
                        <div class="flex flex-col gap-[20px]" v-if="step == 1">
                            ...
                            <div class="flex flex-col relative" data-aos-delay="100">
                                <img class="max-w-[24px] h-auto object-cover absolute top-[38px] left-[18px]"
                            ...
                            <div class="flex flex-col relative" data-aos-delay="200">
                                <img class="max-w-[24px] z-[2] h-auto object-cover absolute top-[38px] left-[18px]"
                                    src="@/static/icons/calendar 01.svg" alt="">
                                <label for="fromCity"
                            ...
                            <div class="flex flex-col relative" data-aos-delay="300">
                                <img class="max-w-[24px] h-auto object-cover absolute top-[38px] left-[18px] z-10"
                                ...
                                <el-select v-model="form.type" name="type" v-validate="'required'"  placeholder="Select" style="width: 100%">
                                    ...
                                    <el-option class="size-of-car-select" label="Boat Trailer" value="Boat Trailer"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="800" height="347"
                                            viewBox="0 0 800 347" fill="none" class="svg replaced-svg">
                                            <path d="M147.4 340.8a37.4 37.4 0 1 1 0-74.8 37.4 37.4 0 0 1 0 74.8z"
                                                stroke="#09265E" stroke-width="11" stroke-miterlimit="10"></path>
                                            <path d="M147.4 312.2a8.9 8.9 0 1 1 0-17.7 8.9 8.9 0 0 1 0 17.7z"
                                                fill="#09265E">
                                            </path>
                                            <path d="m161.7 268.8-14.3 34.6-34.6-14.3m20.3 48.9 14.3-34.6 34.5 14.3"
                                                stroke="#09265E" stroke-width="3" stroke-miterlimit="10"></path>
                                            <path d="m182 289-34.6 14.4-14.3-34.5m-20.2 48.8 34.5-14.3 14.3 34.5"
                                                stroke="#09265E" stroke-width="3" stroke-miterlimit="10"></path>
                                            <path d="M33.8 284.3v-39.7" stroke="#09265E" stroke-width="1.3"
                                                stroke-miterlimit="10"></path>
                                            <path
                                                d="M18.6 267H49v20.7H18.6V267zM800 156.1v-12.6l-44.7-3.6c-33.2-2.5-66.4-4.3-99.5-8-14.7-1.5-29.1-6.7-43.7-10.2-3.6-.8-7.4-1.4-11-1.4-108.1 0-216.2-.5-324.3.3-31 .2-61.8 4.2-92.7 6.5l-37.3 2.8c11.8 9.5 22.2 17.8 32.7 26 1.2.8 3.4.4 5.1.4h611c1.2 0 2.4 0 4.4-.2zM177.7 189l54.9 39.2H116v24h684v-23.7H318.3a242 242 0 0 1-133.4-39l-5.5-3.2-1.7 2.7z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M799.9 204.5v-23.7H218.5c18 9.5 35.1 15.7 53 18.8a286 286 0 0 0 46.1 4.7c158.4.3 316.7.2 475.1.2h7.2zM581.2 96.2c-26-28.8-50.4-56.2-75.4-83.2A42 42 0 0 0 474 0H333c-5.2 0-11.5 6.8-11.5 12.1 0 5.5 6.3 12 11.6 12 34.3 0 68.5.1 102.8-.1 7-.1 11.7 2.3 16 7.6 16.3 20 33 39.6 49.3 59.5 3 3.6 5.9 5.3 10.7 5.3 22.4-.3 44.9-.2 69.3-.2zm-213.7-.6V48.1l-39.7.1c-1.6 0-3.6 1.5-4.8 2.9l-37.2 44.5h81.7z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M392 48.1v47.7h81.6l-5.8-7.3c-10-12-20-24.2-30.3-36.2-1.6-1.9-4.2-4-6.5-4-12.7-.4-25.4-.2-39-.2zm347.7 36.1h-51.5c-1.7.1-3.9 1-5.2 2.3-7 6.6-13.8 13.5-22.4 22l79.1 6.2V84.2zM0 228.2h123v24H0v-24z"
                                                fill="#09265E"></path>
                                            <path d="M596.4 340.8a37.4 37.4 0 1 1 0-74.8 37.4 37.4 0 0 1 0 74.8z"
                                                stroke="#09265E" stroke-width="11" stroke-miterlimit="10"></path>
                                            <path d="M596.4 312.2a8.9 8.9 0 1 1 0-17.7 8.9 8.9 0 0 1 0 17.7z"
                                                fill="#09265E">
                                            </path>
                                            <path d="m610.7 268.8-14.3 34.6-34.6-14.3" stroke="#09265E" stroke-width="3"
                                                stroke-miterlimit="10"></path>
                                            <path d="m582.1 338 14.3-34.6 34.5 14.3m.1-28.7-34.6 14.4-14.3-34.5"
                                                stroke="#09265E" stroke-width="3" stroke-miterlimit="10"></path>
                                            <path d="m561.9 317.7 34.5-14.3 14.3 34.5" stroke="#09265E" stroke-width="3"
                                                stroke-miterlimit="10"></path>
                                            <path d="M693.4 340.8a37.4 37.4 0 1 1 0-74.8 37.4 37.4 0 0 1 0 74.8z"
                                                stroke="#09265E" stroke-width="11" stroke-miterlimit="10"></path>
                                            <path d="M693.4 312.2a8.9 8.9 0 1 1 0-17.7 8.9 8.9 0 0 1 0 17.7z"
                                                fill="#09265E">
                                            </path>
                                            <path d="m707.7 268.8-14.3 34.6-34.6-14.3" stroke="#09265E" stroke-width="3"
                                                stroke-miterlimit="10"></path>
                                            <path d="m679.1 338 14.3-34.6 34.5 14.3m.1-28.7-34.6 14.4-14.3-34.5"
                                                stroke="#09265E" stroke-width="3" stroke-miterlimit="10"></path>
                                            <path d="m658.9 317.7 34.5-14.3 14.3 34.5" stroke="#09265E" stroke-width="3"
                                                stroke-miterlimit="10"></path>
                                        </svg>
                                        <span>Boat Trailer</span>
                                    </el-option>
                                    <el-option class="size-of-car-select" label="Golf Cart" value="Golf Cart"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="417" height="313"
                                            viewBox="0 0 417 313" fill="none" class="svg replaced-svg">
                                            <path d="M356.6 306.8a37.2 37.2 0 1 1 0-74.4 37.2 37.2 0 0 1 0 74.4z"
                                                stroke="#09265E" stroke-width="9.2" stroke-miterlimit="10"></path>
                                            <path d="M356.6 278.4a8.8 8.8 0 1 1 0-17.6 8.8 8.8 0 0 1 0 17.6z"
                                                fill="#09265E">
                                            </path>
                                            <path d="m370.9 235.2-14.3 34.4-34.4-14.2m20.2 48.6 14.2-34.4 34.5 14.2"
                                                stroke="#09265E" stroke-width="3.7" stroke-miterlimit="10"></path>
                                            <path d="m391 255.3-34.4 14.3-14.2-34.4" stroke="#09265E" stroke-width="3.7"
                                                stroke-miterlimit="10"></path>
                                            <path d="m322.3 283.9 34.3-14.3L371 304" stroke="#09265E" stroke-width="3.7"
                                                stroke-miterlimit="10"></path>
                                            <path d="M42 306.8a37.2 37.2 0 1 1 0-74.4 37.2 37.2 0 0 1 0 74.4z"
                                                stroke="#09265E" stroke-width="9.2" stroke-miterlimit="10"></path>
                                            <path d="M42 278.4a8.8 8.8 0 1 1 0-17.6 8.8 8.8 0 0 1 0 17.6z"
                                                fill="#09265E">
                                            </path>
                                            <path d="M56.3 235.2 42 269.6 7.6 255.4M27.8 304 42 269.6l34.4 14.2"
                                                stroke="#09265E" stroke-width="3.7" stroke-miterlimit="10"></path>
                                            <path d="M76.4 255.3 42 269.6l-14.2-34.4M7.6 283.9 42 269.6 56.3 304"
                                                stroke="#09265E" stroke-width="3.7" stroke-miterlimit="10"></path>
                                            <path
                                                d="M58.4 220.5c-26.6-10.2-39.5 1.3-48 8 0 0-9.2-8 14.7-21.7 0 0 2.7-20 35-40 4-2.2 7.2-2.7 10.3-4.4l44-148.3H89.8v-1.3c8-7.1 18.7-12 29.3-12h207.3a24 24 0 0 1 19.6 12V14h-13.4l14.2 93.2c1.4 0 2.3-.9 2.7-.4 4 2.2 5.8 55.5 8.9 58.6 3.5 3 4.9 3 14.6 3 9.8 0 16.5-1.3 20 4.5a94 94 0 0 1 8.4 24.4s13.8 0 13.8 56.8c0 9.8-17.3-38.1-61.2-38.1-44 0-46.7 47-54.6 51.5-8 4.8-11.6 4-20 4H121.9c-11.1 0-13.8 5.3-20.9-5.4-7-10.6-16-35.5-42.6-45.7zm60.4-206.4L76.2 158.8c8-4.9 13.3-6.6 16.8-8.4L133 14h-14.2zm196.2 0 14.6 94.6c4.5-1 9.4-.5 13.4-.5l-14.7-94.1H315zM121.9 226.3c1.8 4 2.2 7 15 6.2a4210 4210 0 0 1 48.5-2.7l4.4-45.2s-6.7-16 8-17c14.7-.8 25.3-.8 25.3-.8s17.8-20 37.7-20.9c0 0 2.7-.4 6.3-1.7 0 0-1.4-8.5 4-17.8 5.3-8.9 14.6-31 28.8-27.5 0 0 5.8-4.9 11.5-4 5.8.4 11.1 3.1 6.3 13.8 0 0 3 1.3 7 .4l-14.1-95H137.4L98 147.3c1.4-.5 2.2-1.4 2.7-1.4 2.2 0 6.6 6.3 4.9 10.3-1.8 4-4.5 5.7-.5 14.6.5.9 1 1.8 1.4 3.1l55-56-.4-.4 3.5-3.5-3.5-15.6-5.8-5.7 2.6-3.1 35.6 35.5-3.1 3-6.7-6.6-14.7-3-3.5 3.5-.4-.5-56.9 56.9c5 16 12.5 44.8 13.8 47.9z"
                                                fill="#09265E"></path>
                                        </svg>
                                        <span>Golf Cart</span>
                                    </el-option>
                                    <el-option class="size-of-car-select" label="Dually Pickup"
                                        value="Dually Pickup"><svg xmlns="http://www.w3.org/2000/svg" width="1200"
                                            height="400" viewBox="0 0 1200 400" fill="none" class="svg replaced-svg">
                                            <path
                                                d="M197.9 295.5c1.3 0 2.7.5 3.8 1.3a55 55 0 0 0-36.2-36.4 6 6 0 0 1 1.2 3.7c0 3.7-3 6.7-6.7 6.7h-21.2a6.7 6.7 0 0 1-5.4-10.5 55 55 0 0 0-36.3 36.2 6.7 6.7 0 0 1 10.3 5.5v21.2a6.6 6.6 0 0 1-10.4 5.5 55 55 0 0 0 36.2 36.3c-.7-1-1.2-2.3-1.2-3.7 0-3.6 3-6.6 6.7-6.6h21.2a6.7 6.7 0 0 1 5.4 10.4 55 55 0 0 0 36.3-36.2 6.7 6.7 0 0 1-10.3-5.5v-21.2a6.6 6.6 0 0 1 6.6-6.7zM149.3 342a29.3 29.3 0 1 1 0-58.5 29.3 29.3 0 0 1 0 58.5z"
                                                fill="#09265E"></path>
                                            <path d="M149.3 337.8a25 25 0 1 0 0-50.2 25 25 0 0 0 0 50.2z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M149.3 225.7a87 87 0 1 0 0 173.9 87 87 0 0 0 0-174zm0 146a59 59 0 1 1 .2-118 59 59 0 0 1-.2 118zm1016.2-217.4-.3 1.2c-1.7 7-2.7 14.3-3.2 21.6-.5 6.7-1 14.2 1.5 20.6 2.3 6 7.7 6.3 12.8 5.2-.1-16.8-1-51-3.2-64-4.6 2.5-6.3 10-7.5 15.4zm-1116.7.8h204.7c1.4-27.3 7.5-46.8 13-59l-2.7 2.1c-7.5 5.2-20.4 7-20.4 7s-28.8.7-83.1 5.9c-54.4 5.2-101.7 15.1-123.2 24.2-14.2 6-19 14.7-20.6 19.8h32.3zM1165.5 242a48 48 0 0 0-.5 2.2h35c0-11.4-4.4-13.3-4.4-13.3h-19.2c-4 1.7-9.6 4.9-11 11.1zm-484.3 83.3H666v9.8h15v-9.8z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M1172.2 207.8a12 12 0 0 1-11.9-8.4c-2.8-7.5-2.3-16-1.8-23.4a152 152 0 0 1 3.3-23.3l.4-1.4c1.3-6.1 3.5-16 9.9-19a45 45 0 0 0-3.2-7.8 85.2 85.2 0 0 0-22-25.8H691.6c-2.2-20-7.8-66.9-11-81.4C677.7 4 666.7 1.1 660.6.6c3.7 47.9 14.7 205.4 8.8 300h201.2a93 93 0 0 1 184.3 0h41.3c6.3 0 11.1-15.7 11.1-15.7h40.5c6.2 0 6.4-5.9 6.4-5.9h.3a1053 1053 0 0 1 7.7-39.2c1.6-7 7.4-10.7 12-12.7.8-3.5 2-9.4 2-14.2v-5.7c-1.4.4-2.7.6-4 .6zm-64.9 53.7-.5.1c-.8 0-1.5-.5-1.6-1.3-28-98.6-54-118.6-154-118.6-41.4 0-74.3 17.7-97.9 52.6-17.5 26-23 52.5-23 52.7-.2 1.1-1.1 1.7-2 1.5-1-.2-1.6-1.2-1.3-2.3.2-1.1 5.6-27.4 23.5-54.1a117.2 117.2 0 0 1 100.7-54.2c102.2 0 128.6 20.4 157.3 121.2.2 1-.3 2.1-1.2 2.4zM23.7 233.6c.5-9 4.2-18.4 8.6-26.2L22 196.2v-25.4h23.3v-11.9H15.7v.5l1.4 74.2h6.6z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M270.7 283.2c-5.5-8.6-16.5-52-17.5-113.2v-11H48.9v30.7l-.4.6c-.3.2-21.3 24.4-21.3 45.2v2H12.4a79.3 79.3 0 0 0-8.5 6.4c-7 6.1-.7 37.7 2.6 49.3 2.7 9.6 15.8 12.3 20.3 13l1.3.1h.3a137.8 137.8 0 0 0 28 4 93 93 0 1 1 185.5 11.4l6 .2h21.4s1.3-12 15-18a712.1 712.1 0 0 1-13.6-20.7zm-42.6-73.6c-.4.5-1.2.8-2 .8l-1.2-.3c-55.3-25-119-12.4-119.7-12.3-1.2.3-2.5-.2-2.8-1.1-.4-1 .3-1.8 1.6-2 .6-.2 66.4-13 123.5 12.7 1 .5 1.3 1.5.6 2.2zM276 325.3h-15v9.8h15v-9.8z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M34.1 204c4.8-8 9.7-14 11.3-15.8v-13.6h-20v20l8.7 9.4zM1158 282.5c8 .3 26.5.7 30.3 0 4.8-1.1 9.8-16.4 11.5-32.7v-1.5h-35.6c-2.3 11.1-5.2 28.1-6.3 34.2zm-492.1 18.1c6-94.6-5-252.7-8.7-300.1H498v300h138.5v24.3h-151v-24.2h9V.6h-19.3s-66.1 1.6-88.1 7.7-35.6 19.6-35.6 19.6-55.7 45-78.7 63.2c-6.4 12.1-16.8 38.1-16.1 78.9.8 60.3 11.6 102.8 16.9 111.1 3.4 5.5 9.8 15.2 14 21.7a43 43 0 0 1 13.4-2v24h-23.2v10.3h386.5V325h-10.1v-24.3h11.7zm-49.4-148.8h-24.6c-6.3 0-11.4-3.5-11.4-8 0-4.4 5.1-8 11.4-8h24.7c6.3 0 11.4 3.6 11.4 8 0 4.5-5.2 8-11.5 8zm16.2-57c0 8.6-6.3 15.6-14.2 15.6h-88.8c-7.8 0-14.2-7-14.2-15.6V32c0-8.6 6.4-15.6 14.2-15.6h88.9c7.8 0 14.2 7 14.2 15.6v62.8zM468 324.8H318.6v-24.2h149.3v24.2zm-49-181c0-4.3 5-8 11.4-8H455c6.3 0 11.4 3.6 11.4 8 0 4.5-5 8.1-11.4 8.1h-24.6c-6.3 0-11.4-3.6-11.4-8zm55-39.3c-1.8 6.5-9.4 6.5-13 6.5h-69.1c-6.4.7-24.3 3.3-28.7 8.4-6.3 7.2-25 10.2-25.7 10.3h-45l-.4-.4c-.4-.3-8.7 3-9.3-8.7a41.8 41.8 0 0 1 9-26.7l1.3-1.4c6.8-7.2 38.5-40.3 76.7-60.8 4.3-2.5 8.5-4.7 12.5-6.3 34.3-14.1 83.3-7.7 85.4-7.5.7 0 6.5 1.3 6.5 16 0 21.6.2 33 .3 54.3l.1 11.2c0 1.6 0 3.4-.6 5.1z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M463 143.9c0-3-3.6-5.6-8-5.6h-24.6c-4.4 0-8 2.5-8 5.6 0 3 3.6 5.5 8 5.5H455c4.4 0 8-2.5 8-5.5zm153.5-5.6h-24.6c-4.4 0-8 2.5-8 5.6 0 3 3.6 5.5 8 5.5h24.7c4.3 0 7.9-2.5 7.9-5.5s-3.6-5.6-8-5.6zm394.8 157.2c1.3 0 2.7.5 3.8 1.3a55 55 0 0 0-36.2-36.4 6 6 0 0 1 1.2 3.7c0 3.7-3 6.7-6.7 6.7h-21.2a6.7 6.7 0 0 1-5.4-10.5 55 55 0 0 0-36.3 36.2A6.7 6.7 0 0 1 921 302v21.2a6.7 6.7 0 0 1-10.5 5.5 55 55 0 0 0 36.2 36.3c-.8-1-1.2-2.3-1.2-3.7 0-3.6 3-6.6 6.7-6.6h21.2a6.7 6.7 0 0 1 5.4 10.4 55 55 0 0 0 36.3-36.2 6.7 6.7 0 0 1-10.4-5.5v-21.2c0-3.7 3-6.7 6.7-6.7zM962.7 342a29.3 29.3 0 1 1 .2-58.5 29.3 29.3 0 0 1-.2 58.5z"
                                                fill="#09265E"></path>
                                            <path d="M962.7 337.8a25 25 0 1 0 0-50.2 25 25 0 0 0 0 50.2z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M962.7 225.7a87 87 0 1 0 .1 173.9 87 87 0 0 0 0-174zm0 146a59 59 0 1 1 .2-118 59 59 0 0 1-.2 118z"
                                                fill="#09265E"></path>
                                        </svg>
                                        <span>Dually Pickup</span>
                                    </el-option>
                                    <el-option class="size-of-car-select" label="Motorcycle" value="Motorcycle">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="400" height="240"
                                            viewBox="0 0 400 240" fill="none" class="svg replaced-svg">
                                            <path
                                                d="m307.8 131.5 12.4-7.2c.9-.5 3 .4 3.5 1.3l10.2 31.9c3.6 2.2 6.2 5.8 6.2 10.7a12 12 0 1 1-24 0c0-1.7.5-3 1-4.9l-10.7-28.2c-.4-1.4 0-2.7 1.4-3.6zM277.2 175H259c-.4 0-.9-.5-.9-1-.4-1.7-.4-4.4-.4-6.2 0-26 13.3-49 33.7-61.5l8 20.2a52.2 52.2 0 0 0-20.9 47.1c0 1-.9 1.4-1.3 1.4zm25.2-46.7-.4-.9c-.5-.9.4-3.1 1.3-3.6l13.3-7.2c1.3-.9 3.1 0 3.6 1.4l.4.9c.5.9-.4 2.2-1.3 3.1l-13.3 7.2c-1.4.9-2.7.9-3.6-.9zM343.2 75l-38.5 4.9.4.4c.4 1-.4 2.3-1.3 3.2l-13.3 7.1c-1 .5-2.2.5-3.1-.9l-3.6-7.1-31.5 4a10 10 0 0 1-10.6-9l-2.2-22c-1-6.7 4-11.2 10.2-11.2l93.5.5c12.5 0 18.2 27.3 0 30zM91 56c-.5 1.9-2.3 2.3-4.5 2.3h-5.8c-2.2 0-4.9-1.8-4.9-4.5-1.3-21-14.6-31.4 0-31.4H94c4 0 6.7 3.6 5.3 7.2L91 56.1z"
                                                fill="#09265E"></path>
                                            <path
                                                d="M209.8 129.2 224 97.4c.4-1.4 1.7-3.2 3.5-3.2l52.8-5.4c2.2 5 4.4 9-1.8 10.8-26.6 8-32 49.3-33.7 71.3-.4 2.3-2.2 4.5-4.9 4.5l-28.4.5c-3.5 0-5.3-4.5-3.5-6.8 8.9-10.7 5.3-29.6 1.8-35.4a7.7 7.7 0 0 1 0-4.5zm86.9-15.2-.5-1c-.4-.8.5-3 1.4-3.5l12.8-7.2c1.4-1 3.1 0 3.6 1.3l.4 1c.5.8-.4 2.2-1.3 3l-13.3 7.2c-1 .5-2.7.5-3.1-.8z"
                                                fill="#09265E"></path>
                                            <path
                                                d="m165 130-9.8-32.7c-.4-1.8.9-3.1 3.1-3.1h50.1c1.8 0 3.1 1.8 2.2 3.6l-13.3 35.4a25 25 0 0 1 7.1 17.5c0 9.4-4 17.5-12.8 22v6.7H302c7.5 0 13.7 6.8 40.3 6.8v9.8c-26.6 0-32.3 6.3-40.3 6.3H192c-14.2 0-23-6.7-23-21v-6.4c-9-4-15.1-13-15.1-23.3.4-9 4.9-16.6 11-21.5z"
                                                fill="#09265E"></path>
                                            <path
                        ...
                        <div class="flex flex-col gap-[20px]" v-if="step == 2">
                            <div class="flex flex-col relative">
                                <svg width="24" class="max-w-[24px] h-auto object-cover absolute top-[38px] left-[18px]"
                            ...
                            <div class="flex flex-col relative">
                                <svg class="max-w-[24px] h-auto object-cover absolute top-[38px] left-[18px]" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div v-if="isSent">
                        <h6 class="mb-24 text-[36px] font-bold text-[#fff]">Thanks for your Message !!!</h6>
                        <p class="mb-24 text-[#fff] text-[24px]">Responsible agent will call you in 1 hour</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    methods: {
        send() {
            if (this.step == 1) {
                ...
                let message = `Customer sent info. Email: ${this.personalInfo.email} phone: ${this.personalInfo.phone} From: ${this.form.from}, To: ${this.form.to}, date: ${this.form.date},
      type:${this.form.type}`

                this.$axios.post(
                    `https://api.telegram.org/bot6084975605:AAG-InYG5EDAh9GQ5rDncJq1y3wMDamvgAo/sendMessage?chat_id=-1001578777251&text=${message}`
