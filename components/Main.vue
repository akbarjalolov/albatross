<template>
  <div class="main-section relative min-h-[98vh] w-full flex flex-col">
    ...
    <div class="w-full max-w-[1400px] flex justify-center mx-auto">
        <img class="w-full h-auto object-cover max-w-[575px]" src="@/static/img/line-button.png"/>
        <c-button :text="buttonText" dynamicClass="max-w-[200px] mx-auto mt-[24px]"></c-button>
    ...
    <div class="w-full mt-[100px] ">
        <div class="w-full flex justify-center mx-auto">
            ...
            <div>
                <img class="w-full h-auto object-cover" src="@/static/img/line-2.png"/>
            </div>
            <div class="max-w-[190px] w-full items-center bg-white border border-solid border-dBlue rounded-xl flex flex-col p-[12px] min-h-[82px]">
                <div class="relative">
            ...
            <div>
                <img class="w-full h-auto object-cover" src="@/static/img/line-3.png"/>
            </div>
            <div class="max-w-[190px] w-full bg-white border border-solid border-dBlue rounded-xl flex flex-col p-[12px] min-h-[82px]">
            ...
            <div>
              <img class="w-full h-auto object-cover rotate-180" src="@/static/img/line-4.png">
            </div>
        </div>
    </div>
        ...
        <div class="w-full flex items-center justify-between">
            ...
            <div class="flex items-center">
                <div :class="{'bg-dBlue' : index == 0}" v-for="(item,index) in statistic" :key="index" class="h-[100px] w-[100px] border-solid border border-dBlue flex flex-col items-center justify-center rounded-full">
                    <h3 class="text-[white] leading-130 text-[24px] font-medium">
                       <number
                          ref="number1"
                          :from="0"
                          :to="item.count"
