  ...
  <footer class="footer flex flex-col items-center justify-center py-[32px]">
    <div class="container mx-auto items-center justify-center">
      ...
      <div class="footer-socials flex items-center justify-center mt-24 gap-2">
        <a :href="settings?.instagram" data-aos="fade-up" :data-aos-delay="'00'" class="
            bg-[#11304D]
            transition-all
            duration-300
            hover:bg-[#00AFEF]
            ...
            h-[40px]
          ">
          <img src="@/static/icons/f-insta.svg" />
        </a>

        <a :href="settings?.linkedin" data-aos="fade-up" :data-aos-delay="'100'" class="
            bg-[#11304D]
            transition-all
            duration-300
            hover:bg-[#00AFEF]
            ...
            h-[40px]
          ">
          <img src="@/static/icons/f-linkedin.svg" />
        </a>

        <a :href="settings?.facebook" data-aos="fade-up" :data-aos-delay="'200'" class="
            bg-[#11304D]
            transition-all
            duration-300
            hover:bg-[#00AFEF]
            ...
            h-[40px]
          ">
          <img src="@/static/icons/f-face.svg" />
        </a>

        <a :href="settings?.twitter" data-aos="fade-up" :data-aos-delay="'300'" class="
            bg-[#11304D]
            transition-all
            duration-300
            hover:bg-[#00AFEF]
      ...
      <div class="
          ...
          mt-[16px]
          md:mt-[64px]
          border-b border-solid border-[#11304D]
          pb-24
        ">
        <client-only>
      ...
      <div class="
        ...
        <div class="flex flex-wrap items-center gap-[24px]">
          <div class="flex items-center gap-[8px] hover-underline" data-aos="fade-up"
            ...
            <a :href="`mailto:${settings?.email}`" class="text-white font-normal text-[16px] leading-130">
              {{ settings?.email }}
            </a>
          </div>
          <a class="flex items-center gap-[8px] hover-underline" :href="`tel: ${settings?.phone_number}`"
            ...
            <h4 class="text-white font-normal text-[16px] leading-130">
